...
The installer verifies pinned bootstrap bytes and release assets; v0.5.1 includes a signed tag, reproducible archive, SBOM, checksums, manifest and provenance.
