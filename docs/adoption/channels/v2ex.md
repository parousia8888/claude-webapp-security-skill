...
目前能力合同共 14 项，其中 8 项 automated/regression-tested，6 项 agent-guided。后者需要项目上下文和人工复核，不包装成全自动扫描器。另有 3 个固定 commit 的普通开源项目旅程，保留零 finding、误报关闭和 unknown 结果，未探测线上实例。
