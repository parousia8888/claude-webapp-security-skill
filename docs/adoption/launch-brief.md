...
The current source contract lists **7 stable narrow detection families** and **2 planned detection capabilities**. Separately, it records **5 evidence/reporting**, **1 lifecycle/distribution**, and **6 agent-guided** capabilities. Demo, report, installer and Action behavior are not counted as vulnerability detection.
