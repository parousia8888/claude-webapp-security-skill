...
| Narrow deterministic source audit | `stable` | Runs 20 stable built-in risk rules and 2 evidence-integrity rules: four shared configuration checks plus eight bounded JavaScript/TypeScript and eight bounded Python leads. Syntax matches remain suspected and this is not whole-program SAST. | [`scripts/lib/source-audit.mjs`](../scripts/lib/source-audit.mjs), [`scripts/lib/js-ts-source-audit.mjs`](../scripts/lib/js-ts-source-audit.mjs), [`scripts/lib/python-source-audit.mjs`](../scripts/lib/python-source-audit.mjs), [`scripts/lib/source-rule-registry.mjs`](../scripts/lib/source-rule-registry.mjs), [`docs/stable-source-rules.json`](../docs/stable-source-rules.json), [`test/js-ts-source-audit.test.mjs`](../test/js-ts-source-audit.test.mjs), [`test/python-source-audit.test.mjs`](../test/python-source-audit.test.mjs), [`test/source-rule-registry.test.mjs`](../test/source-rule-registry.test.mjs) |
...
| Opengrep source data-flow adapter | `stable` | Opt-in Opengrep 1.27.0 adapter with two project-owned, digest-pinned same-file request-to-command taint rules for JavaScript/TypeScript and Python. It is not a general rules catalogue or whole-program SAST; every match remains suspected. | [`rules/opengrep-source.yml`](../rules/opengrep-source.yml), [`scripts/lib/external-adapters.mjs`](../scripts/lib/external-adapters.mjs), [`docs/sast-adapter-benchmark.md`](../docs/sast-adapter-benchmark.md), [`test/external-adapters.test.mjs`](../test/external-adapters.test.mjs), [`test/real-adapters.test.mjs`](../test/real-adapters.test.mjs) |
