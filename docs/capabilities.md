...
| Narrow deterministic source audit | `stable` | Checks four narrow source rule families: lockfile absence, environment-named files, public Node inspector bindings and common production source-map settings. It is not general SAST. | [`scripts/lib/source-audit.mjs`](../scripts/lib/source-audit.mjs), [`scripts/lib/source-rule-registry.mjs`](../scripts/lib/source-rule-registry.mjs), [`docs/stable-source-rules.json`](../docs/stable-source-rules.json), [`test/source-rule-registry.test.mjs`](../test/source-rule-registry.test.mjs), [`test/evidence-loop.test.mjs`](../test/evidence-loop.test.mjs) |
