...
| AWS exposure inventory helper | `stable` | Runs a read-only, permission-aware AWS inventory helper. Denied or unavailable reads remain UNCHECKED and never become fabricated posture findings. | [`scripts/aws-exposure-audit.sh`](../scripts/aws-exposure-audit.sh), [`test/aws-permission-evidence.test.mjs`](../test/aws-permission-evidence.test.mjs) |
...
| Stable multi-format finding reports | `stable` | Renders source v2 and remaining crawl/demo/AWS v1 contracts as JSON, Markdown, escaped HTML, SARIF 2.1.0 and JUnit while preserving evidence states and fingerprints. Shared v2 runtime migration is not complete. | [`docs/finding-v2.schema.json`](../docs/finding-v2.schema.json), [`docs/report-v2.schema.json`](../docs/report-v2.schema.json), [`docs/finding.schema.json`](../docs/finding.schema.json), [`docs/report.schema.json`](../docs/report.schema.json), [`scripts/lib/evidence-v2.mjs`](../scripts/lib/evidence-v2.mjs), [`scripts/lib/evidence.mjs`](../scripts/lib/evidence.mjs), [`test/evidence-loop.test.mjs`](../test/evidence-loop.test.mjs) |
