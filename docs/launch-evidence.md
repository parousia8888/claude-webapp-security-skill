...
| Supporting contract | 8 evidence/reporting, 1 lifecycle/distribution and 6 agent-guided capabilities; none are counted as detection coverage | [Generated matrix](capabilities.md) |
...
| Release | v0.5.2 signed tag, reproducible archive, SPDX SBOM, checksums, manifest and provenance | [v0.5.2 release](https://github.com/parousia8888/web-app-security-skill/releases/tag/v0.5.2) |
