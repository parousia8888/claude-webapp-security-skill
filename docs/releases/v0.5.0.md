...
`git rev-parse 'v0.5.0^{}'`, and verify GitHub provenance. The post-publication verifier trusts
the immutable v0.5.0 asset digests, and the documented bootstrap pins and verifies that verifier
before installation.
