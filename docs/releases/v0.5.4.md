...
v0.5.4 changes the evidence claim, not detector reach. The self-authored planted suite is named
...
- [`v0.5.4 rule-contract conformance`](../conformance/v0.5.4-rule-contract-conformance.md): 20
...
remains 20 built-in risk rules, 2 evidence-integrity rules and 8 opt-in external-adapter rules.
