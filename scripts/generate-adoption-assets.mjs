...
add('docs/adoption/launch-brief.md', [
  ...
  '## What is implemented',
  '',
  `The current source contract lists **${facts.stableDetection} stable narrow detection families** and **${facts.plannedDetection} planned detection adapters**. Separately, it records **${facts.evidenceReporting} evidence/reporting**, **${facts.lifecycleDistribution} lifecycle/distribution**, and **${facts.guided} agent-guided** capabilities. Demo, report, installer and Action behavior are not counted as vulnerability detection.`,
  '',
...
add('docs/adoption/citations.md', [
  ...
  `| \`capabilities.contract\` | The current source contract lists ${facts.stableDetection} stable narrow detection families and ${facts.plannedDetection} planned detection adapters, separately from ${facts.evidenceReporting} evidence/reporting, ${facts.lifecycleDistribution} lifecycle/distribution and ${facts.guided} agent-guided capabilities. | [Generated capability matrix](${capabilityLink}) | Supporting or guided capability counts are not vulnerability coverage or precision. |`,
