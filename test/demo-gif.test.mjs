...
assert.equal(metadata.result.before.high, 13);
assert.equal(metadata.result.before.medium, 6);
assert.equal(metadata.result.after.high, 0);
assert.equal(metadata.result.after.medium, 0);
