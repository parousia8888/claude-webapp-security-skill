...
assert.equal(metadata.result.before.active.high, 13);
assert.equal(metadata.result.before.active.medium, 6);
assert.equal(metadata.result.before.byDomain.security_exposure.high, 2);
assert.equal(metadata.result.before.byDomain.search_discoverability.high, 11);
assert.equal(metadata.result.before.byDomain.search_discoverability.medium, 5);
assert.equal(metadata.result.before.byDomain.reliability.medium, 1);
assert.equal(metadata.result.after.active.high, 0);
assert.equal(metadata.result.after.active.medium, 0);
