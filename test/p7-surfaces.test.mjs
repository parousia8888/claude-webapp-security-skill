...
for (const [script, expected] of [
  ['generate-launch-evidence.mjs', /7 stable detection, 3 planned detection, 5 journeys, 5 studies/],
  ['check-p7-surfaces.mjs', /tutorials, agent lifecycle, 22 capabilities, 5 journeys, 5 studies/],
]) {
